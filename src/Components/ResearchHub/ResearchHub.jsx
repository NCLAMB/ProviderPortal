...
class ResearchHub extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            feedFiltersUrl: document.getElementById('function-server-url').value + "/api/portal/ResearchHub/FeedFilters",
            feedUrl: document.getElementById('function-server-url').value + "/api/Portal/ResearchHub/Feed"
        };
    ...
    //    const url = document.getElementById('function-server-url').value + "/api/portal/ResearchHub/FeedFilters";
    //        const token = response;
    //    const providerId = document.getElementById('provider-id').value;
